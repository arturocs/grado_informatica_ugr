...
/* 	Implementación de la clase "Recta" para representar una recta en el plano.
	...
	Apartado d) Política de acceso a los datos miembros ---> Un sólo 
	método que inicializa todos los coeficientes
	...
	Emplea un único método "SetCoeficientes"
...
int main (void)
{
	...
	// Declaración de los objetos de clase Recta
	
	Recta recta1, recta2; // Los campos de los objetos contienen "basura" 
	
	// Inicialización de los objetos
	
	// Observar el acceso (escritura) a los datos de los objetos "recta1" y "recta2".   
	// Se emplean un único método públicos de escritura. 
